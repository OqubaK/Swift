...
class ResultsViewControllerG: UIViewController {
    
    @IBOutlet var resultAnswerLabel: UILabel!
    @IBOutlet var resultDefintionLabel: UILabel!

    
    var responses: [AnswerG]!
    
    init?(coder: NSCoder, responses: [AnswerG]) {
    ...
    func calculatePersonalityResults() {
        let frequencyOfAnswers = responses.reduce(into:[GameType:Int]()) {
